...
@objc public class EditorView: UIView {
    ...
    public func createTour() {
        ...
        //        createGeometryNode(room: selectedRoom)
        createGeometryNode(room: currentRoom)
        
        //
        //        for (_, hotspot) in selectedRoom.hotspots {
        ...
        if gestureRecognize.state == .ended{
            ...
            if let result = hitResults.first {
                ...
                case .createNode:
                    ...
                    toolbar?.items![0].tintColor = .white
                    
                    let newHotSpot = createNewHotSpotNode(name: "gtav", position: newVector)
