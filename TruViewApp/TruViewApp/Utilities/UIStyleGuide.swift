...
class Utilities {
  ...
  static func roundImageView(image:UIImageView) {
    ...
    static func styleTextField(_ textfield:UITextField) {
        ...
        bottomLine.backgroundColor = #colorLiteral(red: 0.4256733358, green: 0.5473166108, blue: 0.3936028183, alpha: 1)
    ...
    static func styleHighlightedTextField(_ textfield:UITextField) {
