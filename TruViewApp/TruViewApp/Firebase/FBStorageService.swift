...
class FirestoreService {
  ...
  func updateCurrentUser(name: String? = nil, email: String? = nil, phone: String? = nil, agency: String? = nil, license: String? = nil, bio: String? = nil, profilePic: Data? = nil, location: String? = nil, libraryPermission: Bool, completion: @escaping (Result<(), Error>) -> ()){
